...
import { getUiSettingDefaults } from './ui_setting_defaults.js';

const config = getUiSettingDefaults();
    ...
    },
    {
      ...
      modifyAggConfigOnSearchRequestStart(aggConfig, searchSource) {
        ...
        return searchSource
          ...
          .catch(() => {
            throw 'Unable to retrieve max and min values to auto-scale histogram buckets. This may lead to poor visualization performance.';
          });
      },
