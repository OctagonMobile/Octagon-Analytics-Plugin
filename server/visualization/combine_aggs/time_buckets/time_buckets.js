...
import { getUiSettingDefaults } from '../agg_types/buckets/ui_setting_defaults.js';
import { parseInterval } from '../utils/parse_interval';
import { calcAutoIntervalLessThan, calcAutoIntervalNear } from './calc_auto_interval';
import { convertDurationToNormalizedEsInterval, convertIntervalToEsInterval } from './calc_es_interval';

const uiConfig = getUiSettingDefaults();
...
TimeBuckets.prototype.getInterval = function(useNormalizedEsInterval = true) {
  ...
  function readInterval() {
    ...
    return calcAutoIntervalNear(uiConfig['histogram:barTarget'].value, Number(duration));
  }
  ...
  function maybeScaleInterval(interval) {
    ...
    const maxLength = uiConfig['histogram:maxBars'].value;
...
TimeBuckets.prototype.getScaledDateFormat = function() {
  ...
  const rules = uiConfig['dateFormat:scaled'].value;
  ...
  return uiConfig['dateFormat'].value;
};
